...
Here we propose, six different  [Dataset generation method](Dataset_generation.md) as well as a combination of two methods for the seventh.

Models's performance is assess through the [Loss function](Loss_function.md).

We used open source Ncorr DIC for comparison [DL-DIC vs. Classic DIC](DL-DIC_vs_Classic-DIC.md)
